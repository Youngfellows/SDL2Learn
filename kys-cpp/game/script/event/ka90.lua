...
if InTeam(9) == true then goto label0 end;
    exit();
::label0::
    if InTeam(114) == true then goto label1 end;
        exit();
::label1::
        Talk("干，事到如此只好到處看看，看有沒有其他出口，他媽的成昆，等我出去就不要他媽的被我堵到．", 0, 0);
        Talk("臭小子你中計拉!", 9, 0);
        Talk("明教的前任教主們窮終身之功，也沒幾個練成的，他們既然當了教主，自是個個才智卓絕。我在旦夕之間，又怎能勝得過他們？", 145, 0);
        Talk("哈哈，臭小子，你武功雖高，但江湖經驗怎麼如此不足，我將這里唯一出口堵住，看你怎麼出來壞我大事．", 9, 0);
        Talk("信後面還有，乾坤大挪移心法暫由謝遜接掌，日后轉奉新教主。光大我教，驅除胡虜，行善去惡，持正除奸，令我明尊圣火普惠天下世人，新教主其勉之。余將以身上殘存功力，掩石門而和成昆共處。夫人可依秘道全圖脫困。當世無第二人有乾坤大挪移之功，即無第二人能推動此『無妄』位石門，待后世豪杰練成，余及成昆骸骨朽矣。頂天謹白。余名頂天，然于世無功，于教無勛，傷夫人之心，恨而沒，狂言頂天立地，誠可笑也。", 145, 0);
        Talk("陽教主本想將成昆關入秘道，兩人同歸于盡，哪知他支持不到，死得早了，讓那成昆逍遙至今。幸好有此圖，咱們能出去了。", 0, 0);
        Talk("信上說要有乾坤大挪移的功力才能挪動巨石，張公子，你來練一練乾坤大挪移心法，好不好？說不定你聰明過人，一下子便練會了。", 9, 0);
        Talk("受用一朝，一朝便宜。便練一朝，也是好的。", 0, 0);
        DarkScence();
        LightScence();
        SetRoleMagic(9, 0, 35, 900);
        SetRoleMagic(114, 0, 35, 500);
        Talk("上面寫著，此第一層心法，悟性高者七年可成，次者十四年可成。我看張兄弟還沒練成我們全都掛了。", 9, 0);
        Talk("等等，我照上面運氣導行、移宮使勁的法門，試一照行，竟是毫不費力的便做到了。這有甚么難處？何以要練七年才成？", 145, 0);
        Talk("真的還假的，可以的話張兄快練下去吧，哈哈，我們不用死在這了。", 9, 0);
        Talk("成了，弟子張無忌，無意中得窺明教神功心法，旨在脫困求生，并非存心窺竊貴教秘籍。弟子得脫險境之后，自當以此神功為貴教盡力，不敢有負列代教主栽培救命之恩。", 145, 0);
        Talk("張公子，你說有一十九句句子尚未練成，何不休息一會，養足精神，把它都練成了？", 0, 0);
exit();
